<div id="rightbar">
   ...
   <li><span id="aqRB_font">题型:</span><li id="aqRB_input"><select style="height:26px;" id="aqRB_select" name="aqRB_select">
   ...
   <option><span style="font-size:18px;">多选题</span></option>
    ...
    <li><span id="aqRB_font">题目:</span><li id="aqRB_input"><textarea  style="width:50%; height:100px;" name="textarea">请入题目内容</textarea></li></li>
   ...
   <!-- <i class="icon-remove-sign icon-2x"></i>  -->
    ...
    <li><span id="aqRB_font">参考答案:</span>
      <li id="aqRB_input"><input type="text" name="answer" id="aqRB_in1" style="width:15%; height:26px;" value="请入答案内容"/></li>
    </li>
    <li id="difficult">
