<div id="rightbar">
    ...
    <div id="aqRB_main">
   <li><span id="aqRB_font">题型:</span><li id="aqRB_input"><select style="height:26px;" id="aqRB_select">
   ...
   <i class="icon-remove-sign icon-2x"></i>  -->
    ...
    <li><span id="aqRB_font">参考答案:</span>
      <li id="aqRB_input"><input type="text" name="" id="aqRB_in1" style="width:15%; height:26px;" value="请入答案内容"/></li>
    </li>
    <li id="difficult">
